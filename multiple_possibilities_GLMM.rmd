...
#                colour="grey") + 
 ...
 # scale_x_discrete(name ="Chimp ID")+
  scale_y_discrete(breaks=c(3,12,22),labels=c("Control 1", "Test", "Control 2"))+ #name= "Condition",
  guides(color = guide_legend(order = 2),
         shape = guide_legend(order = 1))+
  coord_flip()

ggsave("multiple possibilities_plot.pdf", width = 18, height = 10, units = "cm")
...
```{R eval=FALSE}		
boot.res2=boot.glmm(model.res=mm.2, excl.warnings=T,nboots=1000, para=F)
